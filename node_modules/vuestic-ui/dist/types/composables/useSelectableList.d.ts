...
export declare type SelectableOption = string | number | boolean | Record<string, any>;
export declare type StringOrFunction = string | ((option: SelectableOption) => unknown);
