...
const __injectCSSVars__ = () => {
  useCssVars((_ctx) => ({
    "2c9de218": _ctx.CSSVariables.selectedColor,
    "58710e12": _ctx.CSSVariables.hoverColor,
    "441791b6": _ctx.CSSVariables.tableHeight,
    "cbbcdf6e": _ctx.CSSVariables.theadBg,
    "d1693952": _ctx.CSSVariables.tfootBg,
    "42d90c42": _ctx.gridColumnsCount
  }));
};
...
const _hoisted_10 = { class: "va-data-table__table-tr--expanded va-data-table__table-expanded-content" };
                ...
                default: withCtx(() => [
                  ...
                  (openBlock(true), createElementBlock(Fragment, null, renderList(renderBuffer, (row, index) => {
                    return openBlock(), createElementBlock(Fragment, {
                      ...
                      withDirectives(createElementVNode("tr", _hoisted_10, [
                        createElementVNode("td", {
                        ...
                        [vShow, row.isExpandableRowVisible]
                      ])
                    ], 64);
                  }), 128))
                ]),
