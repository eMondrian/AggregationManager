...
const __injectCSSVars__ = () => {
  useCssVars((_ctx) => ({
    "245fa1b8": _ctx.backgroundColor,
    "61820f33": _ctx.backgroundColorOpacity,
    "4939ebac": _ctx.backgroundMaskColor,
    "5e4cc614": _ctx.backgroundMaskOpacity
  }));
};
