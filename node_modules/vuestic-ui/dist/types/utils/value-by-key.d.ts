 ...
 */
export declare const getValueByKey: <Option extends Record<string, unknown>, R>(option: string | number | boolean | Option | ((...args: any[]) => any), prop: string | ((option: Option) => R)) => Option | R | GetTypeByPath<Option, string> | undefined;
export {};
